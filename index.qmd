...
![](img/yes_but_eartch.png)

::: notes
![The Earth, as seen from outer space](https://f.rpp-noticias.io/2020/12/31/1040805iss062-e-117852jpg.jpg)
:::

## Centre {background-image="img/street-fighter-ii-character-select-screen.jpg" background-size="contain" background-color="#000177"}
...
# Maps and power {.smaller background-color="#393A3B"}
...
::: {.column width="50%"}
![British Empire in 1886. Source: Wikimedia Commons](https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Imperial_Federation%2C_map_of_the_world_showing_the_extent_of_the_British_Empire_in_1886.jpg/960px-Imperial_Federation%2C_map_of_the_world_showing_the_extent_of_the_British_Empire_in_1886.jpg?20111207145101)
:::
:::::
...
![](https://makingmaps.net/wp-content/uploads/2021/06/screen-shot-2021-06-02-at-9.10.14-am.png)
...
![](img/osm_id_editor.png){fig-alt="Editing OSM Data"}

## OSM is huge!

10,158,116 OSM users[^1]

[^1]: According to <https://planet.openstreetmap.org/statistics/data_stats.html>
...
10,158,116 OSM users[^2]

[^2]: According to <https://planet.openstreetmap.org/statistics/data_stats.html>
...
![Kelly 2020](img/iconography.png)
